...
$string['channelgroupnametoformat_desc'] = 'String format {$a->parameter} is possible with the following parameters : courseid, courseshortname, coursefullname, groupid, groupname';
