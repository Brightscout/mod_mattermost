...
$string['oauthservice'] = 'Mattermost Oauth service';
$string['oauthservice_desc'] = 'Oauth service used in Mattermost (LDAP or SAML)';
...
$string['background_restore_desc'] = 'This will prevent waiting while dupplicating a Mattermost module';
