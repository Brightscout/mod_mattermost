...
class mattermost_tools
{
    ...
    public static function mattermost_channel_name($cmid, $course)
    {
        ...
        $channelnametoformat = is_null($channelnametoformat) ? '{$a->moodleid}_{$a->courseshortname}_{$a->moduleid}' : $channelnametoformat;
    ...
    public static function get_channel_link($mattermostchannelid)
    {
        ...
        return $mattermostmanager->get_instance_url() . '/' . $mattermostmanager->get_team_slugname() . '/channels/' . $mattermostchannelid;
    }
}
